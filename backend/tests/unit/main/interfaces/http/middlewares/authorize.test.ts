...
describe('authorize middleware', () => {
  ...
  it('should allow access if user has required role', () => {
    req.user = { userId: 'u1', role: UserRole.BUSINESS_OWNER, tenantId: 't1', tenantSlug: 't1-slug', warehouseId: null };
  ...
  it('should return 403 if user lacks required role', () => {
    req.user = { userId: 'u1', role: UserRole.STAFF, tenantId: 't1', tenantSlug: 't1-slug', warehouseId: null };
